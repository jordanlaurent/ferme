  ...
  <div class="container-fluid my-5">
		<div class="row">
			<div class="m-5">
                ...
                <section class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="posts-tab" data-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="true">Ajouter un commentaire</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="message" rows="3" placeholder="Je me suis rendue a cette exploitation et le gérent est genial ! il vend de superbe pomme d'ile de france..."></textarea>
                                </div>
				...
				<!-- Post Begins -->
				<section class="card mt-4 img  ">
					<div class="border p-2">
						<!-- post header -->
						<div class="row m-0">
							<div class="">
								<a class="text-decoration-none" href="#">
									<img class="" src="https://static-cse.canva.com/blob/189272/canva_creer_photo_de_profil.png" width="50" height="50" alt="...">
								</a>
							</div>
							<div class="flex-grow-1 pl-2">
								<a class="text-decoration-none" href="#">
									<h2 class="text-capitalize h5 mb-0 text-dark">Shushant Singh</h2>
								</a> 
								<p class="small text-dark m-0 mt-1"> 24/06/2021 16H20</p>
							</div>
						...
						<footer class="">
							...
							<div class="">
								<ul class="list-group list-group-horizontal">
									<li class="list-group-item flex-fill text-center p-0 px-lg-2 border border-0 bg-dark ">
										<a class="small text-decoration-none text-white" href="#">
											<i class="far fa-thumbs-up"></i> 20 Like
										</a>
									</li>
									<li class="list-group-item flex-fill text-center p-0 px-lg-2 border border-right-0 border-top-0 border-bottom-0 bg-dark">
										<a class="small text-decoration-none text-white" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
									...
									<section class="mt-3 p-3">
										<form action="">
											<div class="input-group input-group">
												<input type="text" class="form-control" placeholder="Ecrire un commentaire" aria-label="Recipient's username" aria-describedby="basic-addon2">
												<div class="input-group-append">
													<a class="text-decoration-none text-white btn btn-success" href="#" role="button">Commenter</a>
												</div>
											</div>
										</form>
									</section>
									...
									<section>
										<div class="card p-4 mt-3">
											...
											<div class="card-body p-0">
												...
												<a class="card-link small text-dark" href="#">
													<i class="far fa-thumbs-up"></i> 20 Like
												</a>
											</div>
										</div>
...
<style>
.profil{display: flex; align-items: center;}
hr{background-color: rgb(15, 153, 15);}
</style>