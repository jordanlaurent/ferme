...
<div>
<Navbar-header />
    <form @submit="postData" method="post" role="form" class="text-center searchMin">
      ...
      <div class="bg-dark rounded pt-2" >
          <input type="checkbox" name="legume" id="legume" value="legume" v-model="legume">
  ...
  <div class="container mt-5 mb-5" v-for="annonce in annonces" :key="annonce.data">
    <div class="d-flex justify-content-center row">
        <div class="col-md-10">
            <br>
            <div class="row p-2 bg-white border rounded">
                <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image" :src="annonce.imageUrl"></div>
                <div class="col-md-6 mt-1">
                    <h5 class="text-success">{{ annonce.manufacturer}}</h5>
                    <div class="d-flex flex-row">
                        <div class="ratings mr-2 text-warning"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></div><span>310</span>
                    </div>
                    <div class="mt-1 mb-1 spec-1"><span>{{ annonce.description}}</span></div>
                    <div class="mt-1 mb-1 spec-1"><span>{{ annonce.adresse }}</span></div>
                    <p class="text-justify text-truncate para mb-0">Leur site web :{{ annonce.website }}<br><br></p>
                </div>
                <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                    ...
                    <div class="d-flex flex-column mt-4"><button class="btn btn-primary btn-sm" type="button">PLUS D'INFORMATIONS </button><button class="btn btn-outline-primary btn-sm mt-2" type="button">Ajouter au favoris</button></div>
                </div>
            </div>
        </div>
    </div>
    ...
    postData(e) {
     ...
     axios
        .post(
         ...
         legume: JSON.stringify(this.legume),
         fruits: JSON.stringify(this.fruits),
         viande: JSON.stringify(this.viande),
         poisson: JSON.stringify(this.poisson),
         fromage: JSON.stringify(this.fromage),
         vignoble: JSON.stringify(this.vignoble),
